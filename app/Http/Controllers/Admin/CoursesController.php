...
class CoursesController extends Controller
{
    ...
    public function create()
    {
        ...
        $teachers = \App\User::whereHas('role',function($q){$q->where('role_id',2);})->get()->pluck('name', 'id')->prepend(trans('quickadmin.qa_please_select'), '');
    ...
    public function show($id)
    {
        ...
        $teachers = \App\User::get()->pluck('name', 'id')->prepend(trans('quickadmin.qa_please_select'), '');$lessons = \App\Lesson::where('course_id', $id)->get();$tests = \App\Test::where('course_id', $id)->get();
